(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/news/list"], {
          ...
          methods: {
                  ...
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      return n = {
                        page: e.num,
                        limit: e.size
                      }, this.searchForm.title && (n["title"] = "%" + this.searchForm.title + "%"), t.next = 4, this.$api.list("news", n);
                    case 4:
            ...
            onDeleteTap: function (e) {
              ...
              t.showModal({
                ...
                content: "是否确认删除",
                success: function () {
                  var t = a(r.default.mark((function t(i) {
                    return r.default.wrap((function (t) {
                      while (1) switch (t.prev = t.next) {
                        case 0:
                          if (!i.confirm) {
                ...
                return r.default.wrap((function (t) {
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      ...
                      }, this.searchForm.title && (e["title"] = "%" + this.searchForm.title + "%"), t.next = 5, this.$api.list("news", e);
                    case 5:
    ...
    "486a": function (t, e, n) {
      ...
      n("b67f");
      var a, o = n("f0c5"),
        c = Object(o["a"])(i["default"], r["b"], r["c"], !1, null, null, null, !1, r["a"], a);
      e["default"] = c.exports
    },
    "8e42": function (t, e, n) {
      "use strict";
  ...
  [
    ["8e42", "common/runtime", "common/vendor"]
  ]
]);
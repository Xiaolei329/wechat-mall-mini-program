(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
        ...
        var o = {
          ...
          methods: {
            queryChange: function (t) {
              this.queryIndex = t.detail.value, this.searchForm.shangpinfenlei = ""
            },
                  ...
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      return n = {
                        page: e.num,
                        limit: e.size
                      }, this.searchForm.shangpinfenlei && (n["shangpinfenlei"] = "%" + this.searchForm.shangpinfenlei + "%"), t.next = 4, this.$api.list("shangpinfenlei", n);
                    case 4:
                      r = t.sent, 1 == e.num && (this.list = []), this.list = this.list.concat(r.data.list), 0 == r.data.list.length && (this.hasNext = !1), e.endSuccess(e.size, this.hasNext);
                    case 9:
                    case "end":
                      return t.stop()
                  }
                    ...
                    return i.default.wrap((function (t) {
                      while (1) switch (t.prev = t.next) {
                        case 0:
                          ...
                          return t.next = 3, n.$api.del("shangpinfenlei", JSON.stringify([e]));
                        case 3:
                ...
                return i.default.wrap((function (t) {
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      ...
                      }, this.searchForm.shangpinfenlei && (e["shangpinfenlei"] = "%" + this.searchForm.shangpinfenlei + "%"), t.next = 5, this.$api.list("shangpinfenlei", e);
                    case 5:
    ...
    "548f": function (t, e, n) {
      ...
      var i = {
        ...
        r = function () {
          var t = this,
            e = t.$createElement,
            n = (t._self._c, t.isAuth("shangpinfenlei", "修改")),
            i = t.isAuth("shangpinfenlei", "删除"),
            r = t.isAuth("shangpinfenlei", "新增");
  ...
  [
    ["afc6", "common/runtime", "common/vendor"]
  ]
]);
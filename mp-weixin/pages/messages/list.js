(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/messages/list"], {
    ...
    b973: function (t, e, n) {
      ...
      n("b5ce");
      var c, a = n("f0c5"),
        u = Object(a["a"])(i["default"], s["b"], s["c"], !1, null, null, null, !1, s["a"], c);
      e["default"] = u.exports
    },
    c26f: function (t, e, n) {
      "use strict";
      (function (t) {
        ...
        var a = {
          ...
          methods: {
            ...
            upCallback: function () {
              var t = c(s.default.mark((function t(e) {
                var n;
                return s.default.wrap((function (t) {
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      return t.next = 2, this.$api.list("messages", {
                        page: e.num,
                        limit: e.size
                      });
                    case 2:
            ...
            onDeleteTap: function (e) {
              ...
              t.showModal({
                ...
                content: "是否确认删除",
                success: function () {
                  var t = c(s.default.mark((function t(i) {
                    return s.default.wrap((function (t) {
                      while (1) switch (t.prev = t.next) {
                        case 0:
                          if (!i.confirm) {
                ...
                return s.default.wrap((function (t) {
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      ...
                      }, t.next = 4, this.$api.list("messages", e);
                    case 4:
  ...
  [
    ["94be", "common/runtime", "common/vendor"]
  ]
]);
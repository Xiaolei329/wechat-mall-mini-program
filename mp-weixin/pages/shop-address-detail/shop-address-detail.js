(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/shop-address-detail/shop-address-detail"], {
        ...
        var u = {
              ...
              return n.default.wrap((function (e) {
                while (1) switch (e.prev = e.next) {
                  case 0:
                    ...
                    return r = "编辑收货地址", this.id = a.id, e.next = 6, this.$api.info("address", this.id);
                  case 6:
          ...
          methods: {
            ...
            chooseLocation: function () {
              ...
              t.chooseLocation({
                success: function (t) {
                  e.addressData.addressName = t.name, e.addressData.address = t.name
                }
              })
            },
            confirm: function () {
              var t = i(n.default.mark((function t() {
                ...
                return n.default.wrap((function (t) {
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      if (e = this.addressData, e.name) {
                        t.next = 4;
                        break
                      }
                      return this.$utils.msg("请填写收货人姓名"), t.abrupt("return");
                    case 4:
                      if (this.$validate.isMobile(e.phone)) {
                        t.next = 7;
                        break
                      }
                    ...
                    case 10:
                      if (e.default ? e.isdefault = "是" : e.isdefault = "否", !this.id) {
                        t.next = 16;
                        break
                      }
    ...
    "741f": function (t, e, a) {
      ...
      a("9aff");
      var i, u = a("f0c5"),
        d = Object(u["a"])(r["default"], n["b"], n["c"], !1, null, null, null, !1, n["a"], i);
      e["default"] = d.exports
    },
    "9aff": function (t, e, a) {
      "use strict";
  ...
  [
    ["3645", "common/runtime", "common/vendor"]
  ]
]);